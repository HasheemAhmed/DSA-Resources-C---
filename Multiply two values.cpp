...
public:
	...
	void multiplyTwoSmallestNode()
	{
		...
		cout << "Multiplication of smallest Node are : " << small1 * small2 << endl;
	}

	void multiplyTwoLargestNode()
	{
		temp = head;
		int Large1, Large2;
		...
		cout << "Multiplication of LArgest Node are : " << Large1 * Large2 << endl;
	}
};
